...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathDashPathEffect pathDashPathEffect = new PathDashPathEffect(getPath, 40, 0, PathDashPathEffect.Style.MORPH);
        ...
        ComposePathEffect pathEffect = new ComposePathEffect(discretePathEffect, dashPathEffect);
